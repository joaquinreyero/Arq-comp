...
char* urlStart = {"https://api.telegram.org/bot6038152936:AAEwcYM8VsMitg4Bg6YFEGUgXYhdygY2ibM/getUpdates"};
char* urlEscuchar = {"https://api.telegram.org/bot6038152936:AAEwcYM8VsMitg4Bg6YFEGUgXYhdygY2ibM/getUpdates?offset="};
char* urlHablar = {"https://api.telegram.org/bot6038152936:AAEwcYM8VsMitg4Bg6YFEGUgXYhdygY2ibM/sendMessage?chat_id=1013618467&text="};
char cadena[MAX];
